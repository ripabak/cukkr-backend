...
export declare const webPushSubscription: import("drizzle-orm/pg-core").PgTableWithColumns<{
...
export declare const webPushSubscriptionRelations: import("drizzle-orm").Relations<"web_push_subscription", {
    user: import("drizzle-orm").One<"user", true>;
}>;
